...
/**
 * Common interface for all strategies which will be used in LayoutManager
 */
export interface LayoutStrategy {
     ...
     */
    readonly supportsNodeLocking: boolean;
...
export default abstract class LayoutStrategyBase implements ObjectSave, LayoutStrategy {
    /**
     * @internal
